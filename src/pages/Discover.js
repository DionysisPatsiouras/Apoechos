    ...
    <div className={style.container}>
      <div className={style.wrapper}>
        ...
        <div className={style.filterBar}>
          <input type="checkbox" id="rock" onClick={() => setGenre({genre, rock: !genre.rock})} /> <label htmlFor='rock'>Rock</label>
          <input type="checkbox" id="double_bass" onClick={() => setInstrument({instrument, double_bass: !instrument.double_bass })} /> <label htmlFor='double_bass'>double_bass</label>
          <input type="checkbox" id="classic_guitar" onClick={() => setInstrument({instrument, classic_guitar: !instrument.classic_guitar })} /> <label htmlFor='classic_guitar'>classic_guitar</label>
        </div>
